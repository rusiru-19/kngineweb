...
import { Calendar, MapPin, Shield, AlertCircle, CheckCircle, Clock, Users, Award, ExternalLink } from 'lucide-react';
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-12">
                {competitions.map((comp, idx) => (
                  ...
                  >
                    ...
                    <Link
                      href={comp.href}
                      className="inline-flex items-center gap-2 text-[#2563EB] text-sm font-bold uppercase tracking-wide hover:text-white transition-colors group/link"
                    >
