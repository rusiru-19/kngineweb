...
const CodecomPage: React.FC = () => {
  ...
  const webdevParticipationDetails = [
    { icon: <Users className="w-5 h-5" />, label: "Eligibility", value: "Grades 9–13" },
    { icon: <Users className="w-5 h-5" />, label: "Team Size", value: "2–4 members" },
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <div className="flex justify-center gap-4 mb-8">
                <button
                  onClick={() => setActiveTab('codecom')}
                  className={`px-6 sm:px-8 md:px-12 py-3 md:py-4 rounded-full font-black uppercase tracking-widest text-sm md:text-base transition-all ${
                    activeTab === 'codecom'
                      ? 'bg-[#2563EB] text-white'
                      : 'bg-[#121212] text-[#9CA3AF] hover:bg-[#1A1A1A] border border-white/5'
                  }`}
                >
              ...
              {activeTab === 'codecom' ? (
                ...
                <>
                  <div className="flex items-center justify-center gap-3 text-[#9CA3AF] text-sm md:text-base mb-6">
                    <span className="font-bold uppercase tracking-widest">Team (2-4 Members)</span>
            ...
            <section className="px-4 sm:px-6 md:px-8 lg:px-16 pb-12 md:pb-16">
              <div className="max-w-[1200px] mx-auto">
                ...
                <div className="grid sm:grid-cols-3 gap-4 md:gap-6">
                  {codecomParticipationDetails.map((detail, idx) => (
                    <div 
                      key={idx}
                ...
                <div className="bg-[#121212] rounded-3xl border border-white/5 overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody>
                        {codecomJudgingCriteria.map((item, idx) => (
                          <tr 
                            key={idx}
